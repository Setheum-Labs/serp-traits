...
use codec::{Codec, FullCodec, Encode, Decode};
use sp_runtime::{
...
/// ------------------------------------------------------------------------------------------------------------------ /// 
/// ---------vvvvvvvvvvvvvvvvvvvvvvvv Currency - Currency(SetheumCurrency) vvvvvvvvvvvvvvvvvvvvvvvv------------------- /// 
///
///
...
/// ------------------------------------------------------------------------------------------------------------------ /// 
/// ---------vvvvvvvvvvvvvvvvvvvvvvvv Currency - Stp258Currency vvvvvvvvvvvvvvvvvvvvvvvv------------------------------ /// 
///
///
...
pub trait Stp258CurrencyReservable<AccountId>: Stp258Currency<AccountId> {
	...
	/// It changes `TotalIssuance`.
	/// Is a no-op if the `value` to be deposited is zero.
	fn burn_reserved(currency_id: Self::CurrencyId, who: &AccountId, value: Self::Balance,) -> DispatchResult;
